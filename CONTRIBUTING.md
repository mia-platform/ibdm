...
- Before working on a new feature please open an issue for the feature request and participate in
...
- If your PR is adding codes it must also contains test that will cover it, try to cover 100% of
	your added code if possible. During the review be ready to explain why you cannot reach that
	percentage.
