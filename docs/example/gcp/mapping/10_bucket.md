...
This document describes the GCP Bucket mapping used to convert GCP Pub/Sub events into a normalized asset event.

Purpose

- Normalize GCP Storage Bucket events emitted by the Pub/Sub source.
