...
This document describes the GCP Disk mapping used to convert inventory Pub/Sub events into a normalized asset event.

Purpose

- Normalize Persistent Disk resources emitted by the inventory Pub/Sub source.
