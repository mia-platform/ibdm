...
This document describes the GCP Folder mapping used to convert GCP inventory Pub/Sub events into a normalized asset event.

Purpose

- Normalize GCP Folder events emitted by the inventory Pub/Sub source.
